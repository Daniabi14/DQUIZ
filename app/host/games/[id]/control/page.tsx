...
export default function HostControlPage() {
  ...
  // Poll / Fetch responses for active question
  useEffect(() => {
  ...
  // If time runs out while status is QUESTION, automatically close question
  useEffect(() => {
  ...
  // Response statistics breakdown (Prompt item 35)
  ...
  // Options response count breakdown
  ...
  // Sorted leaderboard (Host only, prompt item 36)
  ...
  return (
    <div className="max-w-5xl mx-auto space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
        ...
        {/* Big Live Timer & Response Counter */}
      ...
      {/* Question Statistics & Options Breakdown (Prompt item 35) */}
      ...
      {/* Host Leaderboard Modal (Prompt item 36 - Strictly Restricted to Host) */}
      <Modal
